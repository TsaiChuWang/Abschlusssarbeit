...
// gcc simple_V7.c -o ../Ausführung/simple_V7
// ../Ausführung/simple_V7
...
int main(int argc, char *argv[]){
  ...
  // system("sudo ip netns exec ns1 ping 10.0.0.2 -c 5");
  ...
  if (pthread_create(&thread_send, NULL, sendThread, &source_1)) {
