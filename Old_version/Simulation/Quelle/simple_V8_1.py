...
DATEI_OBJECTIVE_WEG = "../Datei/objective_.txt"
DATEI_FRACTION_WEG = "../Datei/fraction_.csv"

alpha = cvxpy.Variable(nonneg=True)
objective = cvxpy.Minimize(alpha)

def line_chart_tenant(index):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/traffic_{}.csv"
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/images/traffic_{}_linechart.png"
...
def line_chart_gap(index):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/images/traffic_{}_linechart_gap.png"
...
def _total_line_chart(capacity, number, IMAGE_PATH):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/images/traffic_total_linechart.png"
...
def variation_line_chart(title, config_path):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/important_data.csv"
    IMAGE_PATH_MAX_TRANSFER_RATE ="../Datei/simple_V8/simple_V8_1/images/max_transfer_rate_variation.png"
    IMAGE_PATH_ALPHA ="../Datei/simple_V8/simple_V8_1/images/alpha.png"
    config = configparser.ConfigParser()
    config.read(config_path)
...
def allocated_tenant_number_variation(title):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/important_data.csv"
    IMAGE_PATH_ALPHA_ALLOCATED ="../Datei/simple_V8/simple_V8_1/images/alpha_allocated.png"
    dataframe = pd.read_csv(DATA_PATH)
    data = dataframe.values.tolist()
...
def record_An_experiment_MTR():
    ...
    # print(mtr)
    RECORD_DATA_PATH = "../Datei/simple_V8/simple_V8_1/experiment.csv"
    try:
...
def draw_An_experiment_MTR():
    ...
    config = configparser.ConfigParser()
    config.read("../configuration/simple_V8_1.ini")
    # print(config.keys)
    error = float(config['simulation']['error'])
    ...
    IMAGE_PATH_EXPERIMENT_MTR ="../Datei/simple_V8/simple_V8_1/images/experiment_mtr.png"
...
if(int(sys.argv[1]) == 1):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/traffic_{}.csv".format(sys.argv[2])
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/DOTCHART_1_{}.png".format(sys.argv[2])
    dataframe = pd.read_csv(DATA_PATH)
    data = dataframe.values.tolist()
    # print(int(data[-1][0]))
...
if(int(sys.argv[1])==2):
    ...
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/images/Variation_{}.png".format(sys.argv[2])
...
if(int(sys.argv[1])==3):
    DATA_PATH = "../Datei/simple_V8/simple_V8_1/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V8/simple_V8_1/images/Variation_Observation_{}.png".format(sys.argv[2])
    os.system("gcc ./simple_V8_1_variation.c inih/ini.c -o ../Ausführung/simple_V8_1_variation -lcurl -lgsl -lgslcblas -lm")

    colors = random_color(int(sys.argv[3]))
    for i in range(int(sys.argv[3])):

        os.system("../Ausführung/simple_V8_1_variation 5")
