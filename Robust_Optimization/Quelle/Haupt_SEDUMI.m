...
Constraints = [Constraints, 2.145966026289347*norm((y(0,0)*(3.1658205/10.3658205)), 2) <= alpha*C - y(0,0)]
Constraints = [Constraints, 2.145966026289347*norm((y(1,1)*(3.6270764/9.65275)), 2) <= alpha*C - y(1,1)]
Constraints = [Constraints, 2.145966026289347*norm((y(2,2)*(3.6193458/8.478727)), 2) <= alpha*C - y(2,2)]
Constraints = [Constraints, 2.145966026289347*norm((y(0,3)*(3.1658205/10.3658205))+(y(1,3)*(3.6270764/9.65275))+(y(2,3)*(3.6193458/8.478727)), 2) <= alpha*C - (y(0,3)+y(1,3)+y(2,3))]
