...
#define CONFIGURATION_PATH "../configuration/simple_V10.ini"
#define PYTHON_PATH "./simple_V10.py"
#define DATA_STORED_PATH "../Datei/simple_V10/traffic_%d.csv"
#define BUCKET_DATA_STORED_PATH "../Datei/simple_V10/traffic.csv"
// gcc ./simple_V10.c inih/ini.c -o ../Ausführung/simple_V10 -lcurl -lgsl -lgslcblas -lm
// ../Ausführung/simple_V10 c
