...
def line_chart_tenant(index):
    DATA_PATH = "../Datei/simple_V10/traffic_{}.csv"
    IMAGE_PATH = "../Datei/simple_V10/images/traffic_{}_linechart.png"
...
def line_chart_gap(index):
    DATA_PATH = "../Datei/simple_V10/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V10/images/traffic_{}_linechart_gap.png"
...
def _total_line_chart(capacity, number, IMAGE_PATH):
    DATA_PATH = "../Datei/simple_V10/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V10/images/traffic_total_linechart.png"
...
def variation_line_chart(title, config_path):
    DATA_PATH = "../Datei/simple_V10/important_data.csv"
    IMAGE_PATH_MAX_TRANSFER_RATE ="../Datei/simple_V10/images/max_transfer_rate_variation.png"
    IMAGE_PATH_ALPHA ="../Datei/simple_V10/images/alpha.png"
    config = configparser.ConfigParser()
    config.read(config_path)
...
def allocated_tenant_number_variation(title):
    DATA_PATH = "../Datei/simple_V10/important_data.csv"
    IMAGE_PATH_ALPHA_ALLOCATED ="../Datei/simple_V10/images/alpha_allocated.png"
    dataframe = pd.read_csv(DATA_PATH)
    data = dataframe.values.tolist()
...
def record_An_experiment_MTR():
    ...
    # print(mtr)
    RECORD_DATA_PATH = "../Datei/simple_V10/experiment.csv"
    try:
...
def draw_An_experiment_MTR():
    ...
    config = configparser.ConfigParser()
    config.read("../configuration/simple_V10.ini")
    # print(config.keys)
    error = float(config['simulation']['error'])
    ...
    IMAGE_PATH_EXPERIMENT_MTR ="../Datei/simple_V10/images/experiment_mtr.png"
...
if(int(sys.argv[1]) == 1):
    DATA_PATH = "../Datei/simple_V10/traffic_{}.csv".format(sys.argv[2])
    IMAGE_PATH = "../Datei/simple_V10/DOTCHART_1_{}.png".format(sys.argv[2])
    dataframe = pd.read_csv(DATA_PATH)
    data = dataframe.values.tolist()
    # print(int(data[-1][0]))
...
if(int(sys.argv[1])==2):
    ...
    IMAGE_PATH = "../Datei/simple_V10/images/Variation_{}.png".format(sys.argv[2])
...
if(int(sys.argv[1])==3):
    DATA_PATH = "../Datei/simple_V10/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V10/images/Variation_Observation_{}.png".format(sys.argv[2])
    os.system("gcc ./simple_V10_variation.c inih/ini.c -o ../Ausführung/simple_V10_variation -lcurl -lgsl -lgslcblas -lm")
    DATA_PATH_STORED = "../Datei/simple_V10/statistic.csv"
    ...
    for i in range(int(sys.argv[3])):
        ...
        os.system("../Ausführung/simple_V10_variation 3")
...
if(int(sys.argv[1])==4):
    DATA_PATH_STORED = "../Datei/simple_V10/statistic.csv"
    IMAGE_PATH = "../Datei/simple_V10/images/Variation_NTN_{}.png".format(sys.argv[2])
...
if(int(sys.argv[1])==17):
    DATA_PATH = "../Datei/simple_V10/traffic.csv"
    RECORD_PATH = "../Datei/simple_V10/experiments/traffic_{}.csv"
...
if(int(sys.argv[1])==18):
    ...
    IMAGE_PATH_TRANSFER_IMAGE = "../Datei/simple_V10/experiments/transfer_traffic.png"
    ...
    IMAGE_PATH_REAL_IMAGE = "../Datei/simple_V10/experiments/real_traffic.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
...
if(int(sys.argv[1])==19):
    ...
    IMAGE_PATH_MINIMUM_TRAFFIC_IMAG = "../Datei/simple_V10/experiments/minumum_traffic.png"
    ...
    IMAGE_PATH_MEAN_IMAGE = "../Datei/simple_V10/experiments/mean_traffic.png"
...
if(int(sys.argv[1])==20):
    ...
    IMAGE_PATH_TRANSFER_IMAGE = "../Datei/simple_V10/experiments/transfer_traffic_pale.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
    ...
    IMAGE_PATH_REAL_IMAGE = "../Datei/simple_V10/experiments/real_traffic_pale.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
        if(tenant == 0 or tenant == int(tenant_number/2)-1 or tenant == (tenant_number-1)):
