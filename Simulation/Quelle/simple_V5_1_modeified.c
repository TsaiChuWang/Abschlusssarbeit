...
// gcc ./simple_V5_1_modeified.c inih/ini.c -o ../Ausführung/simple_V5_1_modeified -lcurl -lgsl -lgslcblas -lm
// ../Ausführung/simple_V5_1_modeified  7
...
int main(int argc, char *argv[]){
    ...
    naughty_tenant_number = atoi(argv[1]);
...
end_distinguish:
    ...
    sprintf(command, "python3 "PYTHON_PATH" 17 %d",naughty_tenant_number);
    system(command);
