...
// gcc ./simple_V5_MVP.c inih/ini.c -o ../Ausführung/simple_V5_MVP -lcurl -lgsl -lgslcblas -lm
// ../Ausführung/simple_V5_MVP c
...
int main(int argc, char *argv[]){
    ...
    if(argc<2){ // Argument parsing and default assignments
        ...
        if(argc>8){
            tenant_number = atoi(argv[1]);      /** @brief 2 : Number of tenants **/
            time_interval = atoi(argv[2]);      /** @brief 3 : Simulation time (with time units) **/
            error = atof(argv[3]);  
