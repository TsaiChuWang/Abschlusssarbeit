...
// sudo ip netns exec [ns.name] gcc ./simple_V7_4_send.c -o ../Ausführung/simple_V7_4_send
// sudo ip netns exec ns2 gcc simple_V7_4_send.c -o ../Ausführung/simple_V7_4_send
// sudo ip netns exec [ns.name] ../Ausführung/simple_V7_4_send [ns.ip] [destination IP] [ns.id] [ns.name] [time_interval]
// sudo ip netns exec ns2 ../Ausführung/simple_V7_4_send 10.0.0.2 10.0.0.1 2 ns2 10
// sudo ip netns exec ns2 ../Ausführung/simple_V7_4_send 10.0.0.2 10.0.0.1 2 ns2 10
// sudo ip netns exec ns3 ../Ausführung/simple_V7_4_send 10.0.0.3 10.0.0.1 2 ns3 10
int main(int argc, char *argv[]) {
    ...
    // printf("%s\n", command);
    int* traffic = generateNormalDistribution(simulation_time, MEAN, STANDARD_DEVIATION, identifier);
    setbuf(stdout, NULL);
