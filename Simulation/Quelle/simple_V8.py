...
def line_chart_tenant(index):
    DATA_PATH = "../Datei/simple_V8/traffic_{}.csv"
    IMAGE_PATH = "../Datei/simple_V8/images/traffic_{}_linechart.png"
...
def line_chart_gap(index):
    ...
    IMAGE_PATH = "../Datei/simple_V8/images/traffic_{}_linechart_gap.png"
...
def _total_line_chart(capacity, number, IMAGE_PATH):
    DATA_PATH = "../Datei/simple_V8/traffic.csv"
    IMAGE_PATH = "../Datei/simple_V8/images/traffic_total_linechart.png"
...
def variation_line_chart(title, config_path):
    DATA_PATH = "../Datei/simple_V8/important_data.csv"
    IMAGE_PATH_MAX_TRANSFER_RATE ="../Datei/simple_V8/images/max_transfer_rate_variation.png"
    IMAGE_PATH_ALPHA ="../Datei/simple_V8/images/alpha.png"
    config = configparser.ConfigParser()
    config.read(config_path)
...
def allocated_tenant_number_variation(title):
    DATA_PATH = "../Datei/simple_V8/important_data.csv"
    IMAGE_PATH_ALPHA_ALLOCATED ="../Datei/simple_V8/images/alpha_allocated.png"
    dataframe = pd.read_csv(DATA_PATH)
    data = dataframe.values.tolist()
...
def record_An_experiment_MTR():
    ...
    # print(mtr)
    RECORD_DATA_PATH = "../Datei/simple_V8/experiment.csv"
    try:
...
def draw_An_experiment_MTR():
    ...
    IMAGE_PATH_EXPERIMENT_MTR ="../Datei/simple_V8/images/experiment_mtr.png"
...
if(int(sys.argv[1])==17):
    DATA_PATH = "../Datei/simple_V8/traffic.csv"
    RECORD_PATH = "../Datei/simple_V8/experiments/traffic_{}.csv"
...
if(int(sys.argv[1])==18):
    ...
    IMAGE_PATH_TRANSFER_IMAGE = "../Datei/simple_V8/experiments/transfer_traffic.png"
    ...
    IMAGE_PATH_REAL_IMAGE = "../Datei/simple_V8/experiments/real_traffic.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
...
if(int(sys.argv[1])==19):
    ...
    IMAGE_PATH_MINIMUM_TRAFFIC_IMAG = "../Datei/simple_V8/experiments/minumum_traffic.png"
    ...
    IMAGE_PATH_MEAN_IMAGE = "../Datei/simple_V8/experiments/mean_traffic.png"
...
if(int(sys.argv[1])==20):
    ...
    IMAGE_PATH_TRANSFER_IMAGE = "../Datei/simple_V8/experiments/transfer_traffic_pale.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
    ...
    IMAGE_PATH_REAL_IMAGE = "../Datei/simple_V8/experiments/real_traffic_pale.png"
    for tenant in range(tenant_number):
        dataframe = pd.read_csv(RECORD_PATH.format(tenant+1))
        data = dataframe.values.tolist()
        if(tenant == 0 or tenant == int(tenant_number/2)-1 or tenant == (tenant_number-1)):
