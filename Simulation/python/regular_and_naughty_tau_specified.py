...
path = '/home/wtsaichu/Dokumente/Arbeitsplatz/Abschlusssarbeit/Simulation/data/unifrom_naughty'
tail = '_uniform_ditribution'
...
IMAGE_PATH_REGULAR = path+'/images/regular_and_naughty_tau_regular'+tail+'.png'
IMAGE_PATH_NAUGHTY = path+'/images/regular_and_naughty_tau_naughty'+tail+'.png'
DATA_PATH = path+'/regular_and_naughty_tau.csv'
...
if(int(sys.argv[1])==0):
    ...
    title = 'Packet Loss with different τ'
    print(title)
