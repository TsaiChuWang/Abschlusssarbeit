...
# regular_loss_buffer_100 = [i*0.1 for i in regular_loss_buffer_100]
# regular_loss_buffer_150 = [i*0.1 for i in regular_loss_buffer_150]
# regular_loss_buffer_200 = [i*0.1 for i in regular_loss_buffer_200]
# regular_loss_buffer_250 = [i*0.1 for i in regular_loss_buffer_250]

# naughty_loss_buffer_100 = [i*0.1 for i in naughty_loss_buffer_100]
# naughty_loss_buffer_200 = [i*0.1 for i in naughty_loss_buffer_200]
# naughty_loss_buffer_150 = [i*0.1 for i in naughty_loss_buffer_150]
# naughty_loss_buffer_250 = [i*0.1 for i in naughty_loss_buffer_250]
# regular_loss_130 = [i*0.1 for i in regular_loss_130]
# regular_loss_140 = [i*0.1 for i in regular_loss_140]
# regular_loss_150 = [i*0.1 for i in regular_loss_150]

# naughty_loss_130 = [i*0.1 for i in naughty_loss_130]
# naughty_loss_140 = [i*0.1 for i in naughty_loss_140]
# naughty_loss_150 = [i*0.1 for i in naughty_loss_150]

regular_loss_naughty_number_20 = [i*0.1 for i in regular_loss_naughty_number_20]
regular_loss_naughty_number_40 = [i*0.1 for i in regular_loss_naughty_number_40]
regular_loss_naughty_number_60 = [i*0.1 for i in regular_loss_naughty_number_60]
regular_loss_naughty_number_80 = [i*0.1 for i in regular_loss_naughty_number_80]

naughty_loss_naughty_number_20 = [i*0.1 for i in naughty_loss_naughty_number_20]
naughty_loss_naughty_number_40 = [i*0.1 for i in naughty_loss_naughty_number_40]
naughty_loss_naughty_number_60 = [i*0.1 for i in naughty_loss_naughty_number_60]
naughty_loss_naughty_number_80 = [i*0.1 for i in naughty_loss_naughty_number_80]
