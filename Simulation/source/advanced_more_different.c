// /**
//  * @file advanced_more_different.c
...
#define CONFIGURATION_PATH "../configuration/advanced_more_different.ini" ///< Path to the main configuration file

/** @brief Compilation command
 *  @code{.sh}
 *  gcc ./advanced_more_different.c inih/ini.c -o ../execution/advanced_more_different -lm
 *  @endcode
 */

/** @brief Execution command
 *  @code{.sh}
 *  ../execution/advanced_more_different
 *  @endcode
 */
